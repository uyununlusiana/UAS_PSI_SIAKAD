...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	...
	<hl class="h2">Form Data Kurikulum</h1>
	...
	<div class="table-responsive">
		<form action="simpan_kurikulum.php" method="POST">
			<div class="col-6">
				...
				<div class="mb-3">
					<label for="exampleFormControlTextareal" class="form-label">Nama</label>
					<input type="text" name="nama" class="form-control">
				</div>
				<div class="mb-3">
					<label for="exampleFormControlTextareal" class="form-label">Jurusan</label>
					<input type="text" name="jurusan_id" class="form-control">
				</div>
				<div class="mb-3">
					<label for="exampleFormControlTextareal" class="form-label">Sesi</label>
					<input type="text" name="sesi" class="form-control">
				</div>
                <div class="mb-3">
					<label for="exampleFormControlTextareal" class="form-label">Jumlah Sesi</label>
					<input type="text" name="jml_sesi" class="form-control">
				</div>
                <div class="mb-3">
					<label for="exampleFormControlTextareal" class="form-label">Aktif</label>
