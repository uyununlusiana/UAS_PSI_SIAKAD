...
<div class="table-responsive">
    <form action="simpan_nilai.php" method="POST">
       <div class="col-6">
           <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Nilai_ID</label>
                <input type="text" name="nilai_id" class="form-control"placeholder="Nilai_ID">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
             ...
             <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Grade</label>
                <input type="text" name="grade" class="form-control" placeholder="Grade">
            </div>
                  
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Bobot</label>
                <input type="text" name="bobot" class="form-control" placeholder="Bobot">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Nilai Minimal</label>
                <input type="text" name="nilai_min" class="form-control" placeholder="Nilai Minal">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Nilai Maxsimal</label>
                <input type="text" name="nilai_mak" class="form-control" placeholder="Nilai Maxsimal">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Keterangann</label>
